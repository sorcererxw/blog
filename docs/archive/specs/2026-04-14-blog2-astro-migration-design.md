...
- server-side Notion and Telegram credentials are Cloudflare Worker bindings typed by Wrangler-generated `cloudflare-env.d.ts`, not direct `process.env` reads from app code
