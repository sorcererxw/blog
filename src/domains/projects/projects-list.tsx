    ...
    return (
      ...
      >
        <Empty className="mx-auto w-[min(100%-2rem,40rem)] space-y-4 py-16">
          <EmptyContent>
            <p className="m-0 text-xs font-semibold uppercase tracking-widest text-muted-foreground">Projects</p>
              ...
              <Card className="h-full rounded-xl border-[color:color-mix(in_oklab,var(--border)_82%,transparent_18%)] bg-[color:color-mix(in_oklab,var(--card)_94%,white_6%)] py-0 shadow-[0_14px_32px_-28px_color-mix(in_oklab,var(--foreground)_25%,transparent)] transition-[border-color,color,transform] duration-150 hover:-translate-y-0.5 hover:border-[color:color-mix(in_oklab,var(--foreground)_12%,var(--border))] [&:hover_.project-card-cta]:text-foreground [&:hover_.project-card-title]:text-foreground">
                <div className="grid h-full gap-4 px-5 pb-4 pt-5">
                  <div className="flex items-start gap-3">
                    ...
                    <h3 className="project-card-title m-0 font-sans text-lg font-medium leading-tight tracking-tight">
                      {item.title}
                    </h3>
                  </div>
                  <p className="m-0 flex-1 text-base leading-relaxed text-muted-foreground">
                    {item.description}
                  </p>
                  <span className="project-card-cta mt-auto inline-flex text-sm font-semibold uppercase tracking-wide text-muted-foreground transition-colors">
                    Visit project ↗
                  </span>
                </div>
              </Card>
