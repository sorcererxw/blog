...
describe("HomePageContent", () => {
  ...
  it("keeps a row header column when Notion only marks column headers", () => {
    const blocks: HomePageBlock[] = [
      makeBlock({
        id: "table",
        type: "table",
        table: {
          ...
          rows: [
            ...
            {
              cells: [
                { rich_text: [{ plain_text: "HeroUI" }] },
                { rich_text: [{ plain_text: "Table rendering" }] },
              ],
            },
          ],
        },
