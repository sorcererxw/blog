...
} from "@/components/article/article-detail-view";
...
describe("ArticleDetailView", () => {
  ...
  it("marks the first table column as a row header even without Notion row headers", () => {
    const markup = renderToStaticMarkup(
      <ArticleDetailView
        article={{
          ...article,
              ...
              rows: [
                {
                  cells: [
                    {
                      header: true,
                      richText: [{ plainText: "Choice" }],
                    },
                    {
                      header: true,
                      richText: [{ plainText: "Tradeoff" }],
                    },
                  ],
                },
                {
                  cells: [
                    {
                      richText: [{ plainText: "gRPC-Gateway" }],
                    },
                    {
                      richText: [{ plainText: "HTTP friendly" }],
                    },
                  ],
                },
              ],
    ...
    expect(markup).toContain("gRPC-Gateway");
  });
